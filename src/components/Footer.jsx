                    ...
                    <div className="bg-[#00a1ff]/5 dark:bg-[#00a1ff]/10 rounded-[2rem] p-8 md:p-12 mb-20 flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <div className="md:w-1/2 w-full">
                            <form className="flex gap-4">
                                <input type="email" placeholder="Enter your email" className="flex-1 px-6 py-3 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:outline-none focus:border-[#00a1ff] text-gray-900 dark:text-white transition-colors" />
                                <Button variant="primary" className="!px-8">Subscribe</Button>
                            </form>
                        </div>
                    </div>
                </Reveal>
                ...
                <Reveal delay={200} className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            {/* <li><a href="#" className="hover:text-[#00a1ff] transition-colors">Careers</a> <span className="text-xs bg-blue-100 dark:bg-blue-900 text-[#00a1ff] px-2 py-0.5 rounded-full ml-2">Hiring</span></li> */}
